# Generated by Django 2.0.3 on 2018-03-18 09:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bankSystem', '0002_auto_20180318_1221'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='customer',
            name='month_income',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='BYN', max_digits=10),
        ),
        migrations.AddField(
            model_name='customer',
            name='month_income_currency',
        ...
        migrations.AlterField(
            model_name='customer',
            name='reservist',
            field=models.BooleanField(default=False, verbose_name='Военнообязанный'),
        ),
