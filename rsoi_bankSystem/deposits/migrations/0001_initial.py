    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(blank=True, max_length=13, verbose_name='Номер банковского счета')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Active', 'Активный'), ('Passive', 'Пассивный'), ('Active-Passive', 'Активно-Пассивный')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(blank=True, max_length=5, verbose_name='Номер договора')),
                ('start', models.DateField(auto_now_add=True, verbose_name='Дата начала договора')),
                ('end', models.DateField(null=True, verbose_name='Дата конца договора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='deposits.Deposit', verbose_name='Депозит')),
            ],
            options={
                'ordering': ['rate'],
            },
